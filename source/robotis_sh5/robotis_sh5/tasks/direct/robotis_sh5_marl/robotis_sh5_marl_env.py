...
from .robotis_sh5_marl_env_cfg import RobotisSh5MarlEnvCfg


class RobotisSh5MarlEnv(DirectMARLEnv):
    cfg: RobotisSh5MarlEnvCfg

    def __init__(self, cfg: RobotisSh5MarlEnvCfg, render_mode: str | None = None, **kwargs):
