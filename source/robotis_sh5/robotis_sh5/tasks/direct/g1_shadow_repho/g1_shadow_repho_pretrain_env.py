...
from .g1_shadow_repho_env import G1ShadowRephoEnv
from .g1_shadow_repho_pretrain_env_cfg import G1ShadowRephoPretrainEnvCfg


class G1ShadowRephoPretrainEnv(G1ShadowRephoEnv):
    cfg: G1ShadowRephoPretrainEnvCfg
