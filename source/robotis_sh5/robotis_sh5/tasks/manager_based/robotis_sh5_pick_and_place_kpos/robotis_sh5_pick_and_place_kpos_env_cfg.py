...
@configclass
class RobotisSh5PickAndPlaceKposSceneCfg(InteractiveSceneCfg):    
...
@configclass
class RobotisSh5PickAndPlaceKposEnvCfg(ManagerBasedRLEnvCfg):
    """Environment configuration for the Robotis SH5 Pick and Place task."""
    

    scene: RobotisSh5PickAndPlaceKposSceneCfg = RobotisSh5PickAndPlaceKposSceneCfg(num_envs=16, env_spacing=3.0, replicate_physics=True)
    ...
    def __post_init__(self) -> None:
        ...
        file_path = "/home/peunsu/workspace/robotis_sh5/retargeting/mano_trajectories/006_mustard_bottle/20200709_143257.npy"
...
@configclass
class RobotisSh5PickAndPlaceKposEnv_PLAY(RobotisSh5PickAndPlaceKposEnvCfg):
